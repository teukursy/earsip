    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
            ...
            'smtp_user' => '171111068@mhs.stiki.ac.id',  // Email gmail
            'smtp_pass'   => '83036829',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('171111068@mhs.stiki.ac.id', 'Earsip.xyz');

        // Email penerima
        $this->email->to('sutanrisky050615@gmail.com'); // Ganti dengan email tujuan
