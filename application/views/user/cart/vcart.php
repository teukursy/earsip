				...
				<form class="form-horizontal" action="<?php echo site_url("user/Cart/tambah") ?>" method="post" enctype="multipart/form-data" role="form">
					<div class="modal-body">
						<div class="form-group">
							<label class="col-lg-2 col-sm-2 control-label" id="id">No</label>
							<div class="col-lg-10">
								<?= $jml+1;?>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-lg-2 col-sm-2 control-label">Paket Pilihan</label>
							<div class="col-lg-10">
								<select class="form-control" name="paket" id="paket" data-toggle="collapse" onclick="add_forTextfield(this.value)" required>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<select class="form-control" name="harga" id="harga" data-toggle="collapse" onclick="add_forTextfield(this.value)" required>
									<option selected="selected" value="" disabled="">~ Select Type ~</option>
									<option value="100000">Starter</option>
									<option value="135000">Medium</option>
									<option value="150000">Complete</option>
								</select>
							</div>
						</div>
					</div>
