...
<?php $this->load->view("user/_partials/navbar.php") ?>
    ...
    <div id="services" class="cards-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Keuntungan Menggunakan Earsip</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="card-image" src="images/Vector-5.png" alt="alternative">
                        <div class="card-body">
                            <h4 class="card-title">Data Terjamin Aman</h4>
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="card-image" src="images/Vector-3.png" alt="alternative">
                        <div class="card-body">
                            <h4 class="card-title">Mudah untuk Pelaporan</h4>
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="card-image" src="images/Vector-4.png" alt="alternative">
                        <div class="card-body">
                            <h4 class="card-title">Mempercepat Pekerjaan</h4>
    ...
    <div id="pricing" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Pilihan Paket</h2>
                    <p class="p-heading p-large">Kami menyediakan tiga paket berbeda </p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="price">
                                <span class="value">Rp 100.000</span>
                                <div class="frequency">perbulan</div>
                            </div>
                            <hr class="cell-divide-hr">
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Laporan</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Surat Masuk</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Surat Keluar</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Inventaris</div>
                                </li>
                            </ul>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr class="cell-divide-hr">
                            <div class="price">
                                <span class="value">Rp 135.000</span>
                                <div class="frequency">perbulan</div>
                            </div>
                            <hr class="cell-divide-hr">
                            <ul class="list-unstyled li-space-lg">
                                ...
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Surat Keluar</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-times"></i><div class="media-body">Inventaris</div>
                                </li>    
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled li-space-lg">
                                ...
                                <li class="media">
                                    <i class="fas fa-check"></i><div class="media-body">Inventaris</div>
                                </li>
                            </ul>
                            <div class="button-wrapper">
                                <a class="btn-solid-reg page-scroll" href="#request">ORDER</a>
